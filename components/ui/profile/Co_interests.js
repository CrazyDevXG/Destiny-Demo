...
export function Co_Interests(){
        ...
        return(
            ...
            <>
                                ...
                                <div className="grid gap-3 lg:gap-4 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-3 grid-cols-2" uk-scrollspy="target: > div; cls: uk-animation-scale-up; delay: 100;repeat:true">                               
                                            ...
                                            <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                                ...
                                                <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                    <div className="flex items-center gap-2.5 text-white p-3">
                                                        <ion-icon className="text-2xl" name="bookmark-outline"></ion-icon> Music
                                                    </div>
                                                </div>                                    
                                            </div>
                                        </Link>
                                    ...
                                    <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">                                 
                                        <Link href="#">
                                            <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                                ...
                                                <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                    <div className="flex items-center gap-2.5 text-white p-3">
                                                        <ion-icon className="text-2xl" name="bookmark-outline"></ion-icon> Travel
                                                    </div>
                                                </div>                                    
                                            </div>
                                        </Link>
                                    ...
                                    <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">                                
                                        <Link href="#">
                                            <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                                ...
                                                <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                    <div className="flex items-center gap-2.5 text-white p-3">
                                                        <ion-icon className="text-2xl" name="bookmark-outline"></ion-icon> Movie
                                                    </div>
                                                </div>                                    
                                            </div>
                                        </Link>
                                    ...
                                    <div className="lg:hover:scale-105 hover:shadow-lg hover:z-10 duration-500 delay-100">                                
                                        <Link href="#">
                                            <div className="relative w-full lg:h-[270px] aspect-[2.5/4] overflow-hidden rounded-lg shrink-0">                                            
                                                ...
                                                <div className="w-full bottom-0 absolute left-0 bg-gradient-to-t from-black/60 pt-20">
                                                    <div className="flex items-center gap-2.5 text-white p-3">
                                                        <ion-icon className="text-2xl" name="bookmark-outline"></ion-icon> Street Food
                                                    </div>
                                                </div>                                    
                                            </div>
                                        </Link>
