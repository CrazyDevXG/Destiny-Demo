...
export default function Rooms({chatLists}) {    
                            ...
                            return (
                                        ...
                                        <div className="space-y-2 p-2 overflow-y-auto h-[calc(100vh-127px)]">   
                                            ...
                                            <Link key={key} 
                                                  href={`/chat/rooms/${chat.room_id}?idFN=${chat.user_id}`} scroll={false} className="relative flex items-center gap-4 p-2 duration-200 rounded-xl hover:bg-secondery">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2 mb-1.5">
                                                        ...
                                                        <div className="hidden w-2.5 h-2.5 bg-blue-600 rounded-full dark:bg-slate-700"></div>
                                                    </div>
