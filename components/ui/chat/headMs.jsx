            ...
            return(
                ...
                <div className="flex items-center sm:gap-4 gap-2">                                
                    ...
                    <div className="cursor-pointer" uk-toggle="target: .rightt ; cls: hidden">
                        ...
                        <div className={friendInfo.user_online == 1 ? 'text-xs text-green-500 font-semibold' : 'text-xs text-gray-300 font-semibold'}>{friendInfo.user_online == 1 ? 'Online' : 'Offline'}</div>
                    </div>
                </div>  
